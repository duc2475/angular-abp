...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p beb399a1-1992-4ccb-bb35-011705307080
```

> `beb399a1-1992-4ccb-bb35-011705307080` is the password of the certificate, you can change it to any password you want.
